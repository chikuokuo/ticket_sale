...
class TrainSearchTab extends ConsumerWidget {
  const TrainSearchTab({super.key});
  ...
  Future<void> _handleSearch(
    ...
    print('🎯 Search result status: results=${trainState.searchResults.length}, error=${trainState.errorMessage}');
    ...
    if (trainState.errorMessage == null) {
      ...
      print('❌ Showing error message: ${trainState.errorMessage}');
      if (context.mounted) {
